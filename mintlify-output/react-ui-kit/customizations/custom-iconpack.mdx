...
<head>
  ...
  <meta
    name="description"
    content="Learn how to customize meeting icons in React using Dyte's features. Follow our guide for effective icon customization and integration."
  />
</head>
