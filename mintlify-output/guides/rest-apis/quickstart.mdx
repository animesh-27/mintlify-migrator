...
3.  Copy the <b>Authorization Header</b>
4.  Use the copied header in your API requests.

<ThemedImage
  alt="Auth Header"
  className="w-full"
  sources={{
    light: useBaseUrl('/static/dev-portal/auth-header-light.png'),
    dark: useBaseUrl('/static/dev-portal/auth-header-dark.png'),
  }}
/>
...
<head>
  ...
  <meta
    name="description"
    content="Get started with Dyte's REST APIs. Follow our guide for a quickstart on using REST APIs for seamless integration and development."
  />
</head>
