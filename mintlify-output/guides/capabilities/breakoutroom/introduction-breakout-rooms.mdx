...
<head>
  <title>Introduction to Dyte's Breakout Rooms Guide</title>
  <meta
    name="description"
    content="Get an introduction to breakout rooms with Dyte's capabilities. Follow our guide for a smooth understanding and integration."
  />
</head>
