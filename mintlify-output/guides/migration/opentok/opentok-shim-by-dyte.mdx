...
<head>
  <title>Migrate from OpenTok to Dyte with Shim Guide</title>
  <meta
    name="description"
    content="Learn how to use the OpenTok Shim by Dyte for seamless migration. Follow our guide for effective shim implementation and integration."
  />
</head>
