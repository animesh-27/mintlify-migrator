...
- `dyteMobileClient.localUser.audioEnabled`: A <span className="tag-orange">boolean</span> value indicating if the audio is currently enabled.
- `dyteMobileClient.localUser.videoEnabled`: A <span className="tag-orange">boolean</span> value indicating if the video is currently enabled.
