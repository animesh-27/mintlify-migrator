...
<head>
  ...
  <meta
    name="description"
    content="Quickly start integrating your plugin with Dyte using our Plugin SDK Quickstart guide. Streamline the development process for your custom plugins."
  />
</head>
