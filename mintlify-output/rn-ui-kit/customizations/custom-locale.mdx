...
```jsx
import { defaultLanguage, useLanguage } from '@dytesdk/react-native-ui-kit';
```
...
<head>
  ...
  <meta
    name="description"
    content="Learn how to customize meeting locale in React with Dyte's features. Follow our guide for effective customization and localization."
  />
</head>
