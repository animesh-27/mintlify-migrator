...
- **Mix and match**: Use some components from our component library, build some custom components yourself. Checkout the [gallery of available components](/react-native/components)
