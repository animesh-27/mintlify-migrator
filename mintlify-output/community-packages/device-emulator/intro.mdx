...
<head>
  ...
  <meta
    name="description"
    content="Learn about Dyte's community package for device emulation. Explore the documentation to emulate various devices and test applications effectively."
  />
</head>
