...
**Kind**: instance property of [<code>DyteThemePreset</code>](#module_DyteThemePreset)  
<a name="module_DyteThemePreset+livestreamViewerQualities"></a>
...
**Kind**: instance property of [<code>DyteThemePreset</code>](#module_DyteThemePreset)  
<a name="module_DyteThemePreset.fromResponse"></a>

### DyteThemePreset.fromResponse()

**Kind**: static method of [<code>DyteThemePreset</code>](#module_DyteThemePreset)  
**Deprecated.**: Use init()  
<a name="module_DyteThemePreset.default"></a>
