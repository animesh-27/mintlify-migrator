...
**Kind**: instance property of [<code>DytePermissionsPreset</code>](#module_DytePermissionsPreset)  
<a name="module_DytePermissionsPreset.fromResponse"></a>

### meeting.self.permissions.fromResponse()

**Kind**: static method of [<code>DytePermissionsPreset</code>](#module_DytePermissionsPreset)  
**Deprecated.**: Use init()  
<a name="module_DytePermissionsPreset.default"></a>
